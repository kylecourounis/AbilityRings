...
public class AbilityRingsLangProvider extends LanguageProvider {
	...
	private void addTooltips() {
		...
		this.add(AbilityRingsLang.ITEM_EXTENDED_TOOLTIP_FLIGHT_RING, ChatFormatting.GRAY + "Consumes one Feather every " + (ConfigHandler.COMMON.flightRingProperties.consumeTicks.get() / 20) + " seconds as fuel.\n" + ChatFormatting.GRAY + "You can hold up to " + ChatFormatting.YELLOW + ConfigHandler.COMMON.flightRingProperties.maxStorage.get() + " " + consumptionItemName + ChatFormatting.GRAY + " in the ring." + ChatFormatting.GREEN + " [Shift+Right Click] " + ChatFormatting.GRAY + "to consume.\n" + ChatFormatting.GRAY + "Must be in a slot in your hotbar to fly.");
		this.add(AbilityRingsLang.ITEM_TOOLTIP_FOOD_RING, ChatFormatting.YELLOW + "Gives Saturation when placed anywhere in the player's inventory.");
		this.add(AbilityRingsLang.ITEM_TOOLTIP_SPEED_RING, ChatFormatting.YELLOW + "Gives a Speed and Jump Boost, negates fall damage, and gives step-assist when placed in any slot in the your hotbar.");
		this.add(AbilityRingsLang.ITEM_TOOLTIP_HEALING_RING, ChatFormatting.YELLOW + "Gives Regeneration & Absorption when placed anywhere in your inventory.");
	}
