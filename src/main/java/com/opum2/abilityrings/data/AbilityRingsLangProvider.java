...
public class AbilityRingsLangProvider extends LanguageProvider {
    ...
    private void addTooltips() {
        ...
        this.add(AbilityRingsLang.ITEM_EXTENDED_TOOLTIP_FLIGHT_RING,
        ...
        this.add(AbilityRingsLang.ITEM_TOOLTIP_RESISTANCE_RING, ChatFormatting.YELLOW + "Gives Fire Resistance when placed anywhere in your inventory.\nGives both Resistance & Fire Resistance when placed in the hotbar.");
    }
